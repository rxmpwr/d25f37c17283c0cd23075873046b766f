...
class PromptTabManager:
    ...
    def generate_prompts(self):
        ...
        try:
            ...
            messagebox.showinfo("Success", f"Generated {len(prompts)} prompts successfully!")
...
- Clear value proposition""",
    ...
    def export_prompts(self):
        ...
        if not self.current_prompts:
            messagebox.showwarning("No Data", "No prompts to export!")
            return
    ...
    def copy_prompts(self):
        ...
        if not self.current_prompts:
            messagebox.showwarning("No Data", "No prompts to copy!")
            return
