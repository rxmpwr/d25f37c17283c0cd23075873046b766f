...
class SettingsTabManager:
    ...
    def setup_generation_settings(self):
        ...
        # Quality settings
        quality_options = ["Balanced", "Chất lượng", "Speed"]
        ctk.CTkLabel(gen_frame, text="Chất lượng:").grid(
    ...
    def test_openai_key(self, entry_widget):
        ...
        if not key:
            messagebox.showwarning("Cảnh báo", "Please enter an API key")
            return
    ...
    def test_google_credential(self, file_label):
        ...
        if not hasattr(file_label, 'file_path'):
            messagebox.showwarning("Cảnh báo", "Please select a credential file")
            return
    ...
    def test_leonardo_api(self):
        ...
        if not key:
            messagebox.showwarning("Cảnh báo", "Please enter Leonardo AI API key")
            return
    ...
    def save_all_settings(self):
        ...
        try:
            ...
            if self.config_manager.save_config():
                ...
                messagebox.showerror("Lỗi", "Failed to save settings")
                
        except Exception as e:
            messagebox.showerror("Lỗi", f"Failed to save settings: {e}")
    ...
    def clear_all_keys(self):
        ...
        if messagebox.askyesno("Confirm", "Are you sure you want to clear all API keys?"):
            ...
            messagebox.showinfo("Thành công", "All API keys cleared!")
